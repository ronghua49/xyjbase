  ...
  export default {
      ...
      return {
        ...
        tablemain: {
          ...
          bExport: {
            ...
            tableName: "DfDevice",//如果为空系统默认为，表初始化关键字
    ...
    methods: {
      ...
      drawLine(res) {
        ...
        let arr = [
          {value: res[0].openpro, name: '开启'},
          {value: res[0].closepro, name: '关闭'},
          {value: res[0].unkpro, name: '未知'},
        ]
