  ...
  export default {
    ...
    data() {
      return {
        ...
        tablemain: {
          ...
          //表初始化关键字，一般为表名
          tableName: "ParkingIncomeStatVo",
          //查询时的排序字段
          sorter: [],
          //业务数据微服务,查询与高级查询
          bQuery: {
            hostUrl: this.global.partplatz,
            url: "cprfeerecord/incomeStat",
            method: 'post',
          ...
          bExport: {
            ...
            tableName: "ParkingIncomeStatVo",//如果为空系统默认为，表初始化关键字
    ...
    methods: {
      getData(data,res){
        ...
        console.log("res", res);
        this.drawLine(res.data["income_percent"]);
        this.drawLine2(res.data["month_trends"]);
      },
      drawLine(res) {
        let arr1 = [];
