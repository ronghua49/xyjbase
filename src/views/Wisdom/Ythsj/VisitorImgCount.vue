    ...
    data() {
      return {
        ...
        tablemain: {
          ...
          formatters: {
            visitType: function (row, column, cellValue, index) {
              switch (cellValue) {
                case 0:
                  return "小区门口机";
                  break;
          ...
          //表初始化关键字，一般为表名
          tableName: "CallerStatVo",
          //查询时的排序字段
          sorter: [],
          //业务数据微服务,查询与高级查询
          bQuery: {
            hostUrl: this.global.doorUrl,
            url: "nestleHomelandController/visitorImg",
            method: 'post',
          ...
          bExport: {
            ...
            tableName: " CallerStatVo",//如果为空系统默认为，表初始化关键字
