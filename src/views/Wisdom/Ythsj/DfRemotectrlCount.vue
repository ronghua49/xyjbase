  ...
  export default {
    ...
    data() {
      return {
        ...
        tablemain: {
          ...
          //表初始化关键字，一般为表名
          tableName: "DfRemotectrl",
          //查询时的排序字段
          sorter: [],
          //业务数据微服务,查询与高级查询
          bQuery: {
            hostUrl: this.global.doorUrl,
            url: "dfRemotectrl/repealalarm",
            method: 'post',
          ...
          bExport: {
            ...
            tableName: "DfRemotectrl",//如果为空系统默认为，表初始化关键字
    ...
    methods: {
      ...
      drawLine(res) {
        ...
        let arr = [
          {value: res[0].allback, name: '全撤'},
          {value: res[0].goout, name: '外出'},
          {value: res[0].inhome, name: '在家'},
          {value: res[0].rest, name: '休息'},
        ];
