    ...
    data() {
      return {
        tablemain: {
          ...
          formatters: {
            billState: function (row, column, cellValue, index) {
              switch (cellValue) {
                case '0':
                  return "未缴费";
                  break;
          ...
          //表初始化关键字，一般为表名
          tableName: "CallPoliceVo",
          //查询时的排序字段
          sorter: [],
          //业务数据微服务,查询与高级查询
          bQuery: {
            hostUrl: this.global.doorUrl,
            url: "nestleHomelandController/callPoliceMsg",
            method: 'post',
          ...
          bExport: {
            ...
            tableName: "CallPoliceVo",//如果为空系统默认为，表初始化关键字
