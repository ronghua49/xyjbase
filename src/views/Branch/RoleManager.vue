<template>
	<div class="page-container">
		...
		<!--表格内容栏-->
		<kt-table id="ktable" :width=100 :delet="false" permsEdit="sys:role:edit" :highlightCurrentRow="true" :stripe="false" :data="pageResult" :columns="columns" :showBatchDelete="false" @handleCurrentChange="handleRoleSelectChange" @query="findPage" @handleEdit="handleEdit">
		</kt-table>
		<!--新增编辑界面-->
