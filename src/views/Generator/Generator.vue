<template>
  <div class="page">
    <h2 class="header">XYJ Generator</h2>
    <div class="intro">
      <p>Xyj代码生成器，可以通过界面配置快速生成包括 model，dao，service，controller 以及页面的相关代码。</p>
      <p>项目地址：<a href="https://gitee.com/liuge1988/xyj-generator">https://gitee.com/liuge1988/xyj-generator</a>
