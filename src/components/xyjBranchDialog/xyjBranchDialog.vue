<template>
	<div>
		<el-dialog v-dialogDrag title="子公司管理" :close-on-click-modal="false" :visible.sync="dialogVisible" center width="950px">
			...
			<div style="text-align: center;border: 1px solid #ccc;height: 398px;">
				<div class="table">
					<xyj-table ref="userTable" id="1" v-bind="tableConfig" style="width: 700px;"></xyj-table>
				</div>
				<i></i>
				<div class="show">
					<el-button type="text" @click="chooseList = []">清空</el-button>
					<span style="display: block;">已选子公司</span>
