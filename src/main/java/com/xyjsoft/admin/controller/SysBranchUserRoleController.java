...
/**
 * ---------------------------
 * 子公司用户角色表 (SysBranchUserRoleController)         
 * ---------------------------
 * 作者：  xyjsoft
 ...
 */
@RestController
@RequestMapping("sysBranchUserRole")
@Api(tags="SysBranchUserRoleController 子公司用户角色表")
public class SysBranchUserRoleController {
	...
	@ApiOperation(value = "新增,更新子公司用户角色表数据", httpMethod = "POST", notes = "新增,更新子公司用户角色表数据")
	public HttpResult save(@ApiParam(name="SysBranchUserRole",value="子公司用户角色表业务对象") @RequestBody SysBranchUserRole record) {
		return HttpResult.ok(sysBranchUserRoleService.save(record));
	}
	...
	@ApiOperation(value = "删除子公司用户角色表记录", httpMethod = "POST", notes = "删除子公司用户角色表记录")
	public HttpResult delete(@ApiParam(name="SysBranchUserRole列表",value="SysBranchUserRole列表")@RequestBody List<Long> records) {
		return HttpResult.ok(sysBranchUserRoleService.deleteT(records));
	}
	...
	@ApiOperation(value="子公司用户角色表数据列表", httpMethod = "POST", notes = "获取子公司用户角色表列表")
	public HttpResult findPage(@ApiParam(name="PageRequest",value="查询对象")@RequestBody PageRequest pageRequest) {
		return HttpResult.ok(sysBranchUserRoleService.findPage(pageRequest));
	}
	...
	@ApiOperation(value="子公司用户角色表数据详情",httpMethod = "GET",notes = "子公司用户角色表数据详情")
	public HttpResult findById(@ApiParam(name="id",value="业务对象主键")@RequestParam Long id) {
		return HttpResult.ok(sysBranchUserRoleService.findById(id));
	}
	...
	public HttpResult query(@ApiParam(name="QueryFilter",value="查询对象")@RequestBody QueryFilter queryFilter) throws SystemException, Exception {
		PageList<SysBranchUserRole> query = sysBranchUserRoleService.query(queryFilter);
	...
	public HttpResult disposeApply(@ApiParam(name="XyjActivitiPuth",value="审批数据对象")@RequestBody XyjActivitiPuth xyjActivitiPuth) throws SystemException, Exception {
		Boolean b = sysBranchUserRoleService.disposeApply(xyjActivitiPuth);
